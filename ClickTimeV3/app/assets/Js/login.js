...
function logar() {
    ...
    if (usuarioArmazenado) {
        if (usuarioArmazenado.username === username && usuarioArmazenado.senha === senha) {
            ...
            window.location.href = '../sistema/sistema.html'; // Altere para a página que deseja redirecionar
        } else {
...
// Função para exibir o nome do usuário na página sistema/sistema.html
